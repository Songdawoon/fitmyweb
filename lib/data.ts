...
export const portfolioSamples: PortfolioItem[] = [
  ...
  },
  {
    ...
    category: "shop",
    url: "https://fitmyweb-portfolio-31.vercel.app",
    image: "/portfolio/halfstop.jpg",
  },
  {
    title: "기체 연령과 좌석 간격을 숫자로 먼저 보여주는 저비용 항공사 사이트",
    industry: "항공 · 저비용 항공사",
    focus: "노선 운임 조회 · 좌석 비교",
    category: "etc",
    url: "https://fitmyweb-portfolio-30.vercel.app",
    image: "/portfolio/narae.jpg",
  },
  {
    title: "복구문구도 지갑 주소도 없애고 사전 등록으로 연결하는 결제 서비스 소개",
    industry: "비트코인 기반 결제 서비스",
    focus: "구조 설명 · 사전 등록 동선",
    category: "etc",
    url: "https://fitmyweb-portfolio-27.vercel.app",
    image: "/portfolio/kcoin.jpg",
  },
  {
    title: "출력과 용량을 화면으로 보여주고 바로 구매로 잇는 보조배터리 제품 사이트",
    industry: "보조배터리 · 전자기기",
    focus: "제품 스펙 비교 · 바로 구매",
    category: "shop",
    url: "https://fitmyweb-portfolio-26.vercel.app",
    image: "/portfolio/bloc.jpg",
  },
  {
    title: "돌봄 원칙과 하루 일과를 먼저 공개하고 입원 상담으로 잇는 요양병원 홈페이지",
    industry: "요양병원 · 용인 처인",
    focus: "병실 안내 · 입원 상담 신청",
    category: "clinic",
    url: "https://fitmyweb-portfolio-28.vercel.app",
    image: "/portfolio/somang.jpg",
  },
  {
    title: "쓰는 재료의 산지부터 밝히고 첫 방문 상담으로 연결하는 에스테틱 사이트",
    industry: "에스테틱 · 3개 지점",
    focus: "프로그램 안내 · 방문 예약",
    category: "brand",
    url: "https://fitmyweb-portfolio-24.vercel.app",
    image: "/portfolio/chaeon.jpg",
  },
  {
    title: "첨삭 과정을 단계로 보여주고 상담 신청으로 잇는 중등 영어 에세이 학원 사이트",
    industry: "중등 영어 에세이 학원 · 3개 지점",
    focus: "레벨별 커리큘럼 · 상담 신청",
    category: "academy",
    url: "https://fitmyweb-portfolio-23.vercel.app",
    image: "/portfolio/meridian.jpg",
  },
  {
